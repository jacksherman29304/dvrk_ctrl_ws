...
def ps_to_frame(ps: PoseStamped):
    ...
    roll, pitch, yaw = Rotation.Quaternion(ps.pose.orientation.x,ps.pose.orientation.y,ps.pose.orientation.z,ps.pose.orientation.w)
...
def rbs_to_frame(rbs: RigidBodyState):
    ...
    roll, pitch, yaw = Rotation.Quaternion(rbs.pose.orientation.x, rbs.pose.orientation.y, rbs.pose.orientation.z, rbs.pose.orientation.w)
