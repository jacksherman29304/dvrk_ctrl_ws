...
#ifndef PEG_TRANSFER_INTERFACES__SRV__DETAIL__GET_OBJECT_POSE__FUNCTIONS_H_
#define PEG_TRANSFER_INTERFACES__SRV__DETAIL__GET_OBJECT_POSE__FUNCTIONS_H_
...
#include "peg_transfer_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "peg_transfer_interfaces/srv/detail/get_object_pose__struct.h"
 ...
 * )) before or use
 * peg_transfer_interfaces__srv__GetObjectPose_Request__create()
 ...
 * calls
 * peg_transfer_interfaces__srv__GetObjectPose_Request__init().
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Request__fini()
 ...
 * peg_transfer_interfaces__srv__GetObjectPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * peg_transfer_interfaces__srv__GetObjectPose_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * peg_transfer_interfaces__srv__GetObjectPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It allocates the memory for the array and calls
 * peg_transfer_interfaces__srv__GetObjectPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * peg_transfer_interfaces__srv__GetObjectPose_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * peg_transfer_interfaces__srv__GetObjectPose_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It allocates the memory for the array and calls
 * peg_transfer_interfaces__srv__GetObjectPose_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_peg_transfer_interfaces
...
/**
 * It calls
 * peg_transfer_interfaces__srv__GetObjectPose_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PEG_TRANSFER_INTERFACES__SRV__DETAIL__GET_OBJECT_POSE__FUNCTIONS_H_
